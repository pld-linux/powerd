...
Powerd jest efektywnym demonem, który potrafi monitorować UPS-a oraz
bezpiecznie zamknąć komputer. Potrafi także zakomunikować innym
demonom w sieci, które mogą nie potrafić monitorować linii szeregowej,
tak że mogą być one także bezpiecznie zamknięte. Demon ten potrafi
automatycznie identyfikować UPS-a i konfigurację kabla.
